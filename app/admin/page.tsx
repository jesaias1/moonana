        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">Here&apos;s what&apos;s happening in Moonana Studio today.</p>
            </div>
            <Link href="/studio" className="flex items-center gap-2 px-6 py-3 bg-accent text-black font-bold rounded-xl hover:bg-yellow-300 transition-colors shadow-lg shadow-accent/20">
          ...
          {activeView === 'analytics' ? (
            ...
            <div className="bg-panel border border-panelBorder rounded-2xl p-8 max-w-2xl">
              <h2 className="text-xl font-bold mb-4 flex items-center gap-2">
                <CreditCard className="w-6 h-6 text-yellow-500" /> Subscription Management
              </h2>
              ...
              <div className="p-4 bg-black/40 border border-panelBorder rounded-xl font-mono text-sm text-yellow-200/80">
